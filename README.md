...
<details>
<summary><strong>🔑 Como funciona o sistema de licenças?</strong></summary>

Cada licença é **única e vinculada ao seu computador** através do HWID (Hardware ID). Isso significa que:
- ✅ **Segurança máxima** contra pirataria
- ✅ **Não pode ser compartilhada** entre computadores
...
<details>
<summary><strong>💰 Posso pedir reembolso?</strong></summary>

Sim! Oferecemos **garantia de 7 dias** para reembolso:
- ✅ **Motivo válido** (software não funciona conforme anunciado)
- ✅ **Dentro do prazo** de 7 dias após a compra
- ✅ **Contato via Discord** para solicitação
- ✅ **Processamento em até 3 dias úteis**

</details>

<details>
<summary><strong>🖥️ Posso usar em outro computador?</strong></summary>

**Não diretamente**, pois a licença fica vinculada ao HWID. Porém:
- 🔄 **Upgrade de hardware**: Entre em contato para transferir
- 🆕 **Computador novo**: Solicitação de transferência via suporte
- 👥 **Múltiplos PCs**: Adquira licenças separadas
- 🛠️ **Manutenção**: Backup temporário disponível

</details>

<details>
<summary><strong>⚡ Como acelerar os downloads?</strong></summary>

Várias estratégias para maximizar a velocidade:
- 🌐 **Conexão estável**: Use cabo ethernet quando possível
- 🔧 **Configuração otimizada**: 4-8 threads simultâneas
- ⏰ **Horário adequado**: Evite picos de tráfego
- 🚀 **Memória RAM**: Mínimo 8GB para melhor performance

</details>

<details>
<summary><strong>🎵 Quais plataformas são suportadas?</strong></summary>

**Suporte completo** para as principais plataformas:
- ✅ **YouTube** - Vídeos, música, playlists
- ✅ **Spotify** - Músicas, álbuns, playlists  
- ✅ **Instagram** - Vídeos, fotos, stories
- ✅ **TikTok** - Vídeos em alta qualidade
- ✅ **SoundCloud** - Tracks e playlists
- ✅ **Facebook** - Vídeos e lives
- ✅ **E muito mais!**
